...
pub mod egr {
    pub mod cc1g {
        pub fn get() -> u32 {
            unsafe {
                (core::ptr::read_volatile(0x40015014u32 as *const u32) >> 1) & 0x1
            }
        }

        pub fn set(val: u32) {
            unsafe {
                let mut reg = core::ptr::read_volatile(0x40015014u32 as *const u32);
                reg &= 0xFFFFFFFEu32;
                reg |= (val & 0x1) << 1;
    ...
    pub mod ug {
        pub fn get() -> u32 {
            unsafe {
                core::ptr::read_volatile(0x40015014u32 as *const u32) & 0x1
            }
        }
