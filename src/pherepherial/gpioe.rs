...
impl Crl {
    ...
    #[inline(always)]
    pub fn write(self) {
       unsafe { *((0x40011800u32 + 0x0u32) as *mut u32) = self.raw; }
    }
}
...
pub mod crl {
    ...
    pub fn read() -> super::Crl {
        super::Crl {
            raw: unsafe { *((0x40011800u32 + 0x0u32) as *const u32) }
        }
    }

    #[inline(always)]
    pub fn write(val: & super::Crl) {
       unsafe { *((0x40011800u32 + 0x0u32) as *mut u32) = val.raw; }
    }
}
...
impl Crh {
    ...
    #[inline(always)]
    pub fn write(self) {
       unsafe { *((0x40011800u32 + 0x4u32) as *mut u32) = self.raw; }
    }
}
...
pub mod crh {
    ...
    pub fn read() -> super::Crh {
        super::Crh {
            raw: unsafe { *((0x40011800u32 + 0x4u32) as *const u32) }
        }
    }

    #[inline(always)]
    pub fn write(val: & super::Crh) {
       unsafe { *((0x40011800u32 + 0x4u32) as *mut u32) = val.raw; }
    }
}
...
impl Idr {
    ...
    #[inline(always)]
    pub fn write(self) {
       unsafe { *((0x40011800u32 + 0x8u32) as *mut u32) = self.raw; }
    }
}
...
pub mod idr {
    ...
    pub fn read() -> super::Idr {
        super::Idr {
            raw: unsafe { *((0x40011800u32 + 0x8u32) as *const u32) }
        }
    }

    #[inline(always)]
    pub fn write(val: & super::Idr) {
       unsafe { *((0x40011800u32 + 0x8u32) as *mut u32) = val.raw; }
    }
}
...
impl Odr {
    ...
    #[inline(always)]
    pub fn write(self) {
       unsafe { *((0x40011800u32 + 0xCu32) as *mut u32) = self.raw; }
    }
}
...
pub mod odr {
    ...
    pub fn read() -> super::Odr {
        super::Odr {
            raw: unsafe { *((0x40011800u32 + 0xCu32) as *const u32) }
        }
    }

    #[inline(always)]
    pub fn write(val: & super::Odr) {
       unsafe { *((0x40011800u32 + 0xCu32) as *mut u32) = val.raw; }
    }
}
...
impl Bsrr {
    ...
    #[inline(always)]
    pub fn write(self) {
       unsafe { *((0x40011800u32 + 0x10u32) as *mut u32) = self.raw; }
    }
}
...
pub mod bsrr {
    ...
    pub fn read() -> super::Bsrr {
        super::Bsrr {
            raw: unsafe { *((0x40011800u32 + 0x10u32) as *const u32) }
        }
    }

    #[inline(always)]
    pub fn write(val: & super::Bsrr) {
       unsafe { *((0x40011800u32 + 0x10u32) as *mut u32) = val.raw; }
    }
}
...
impl Brr {
    ...
    #[inline(always)]
    pub fn write(self) {
       unsafe { *((0x40011800u32 + 0x14u32) as *mut u32) = self.raw; }
    }
}
...
pub mod brr {
    ...
    pub fn read() -> super::Brr {
        super::Brr {
            raw: unsafe { *((0x40011800u32 + 0x14u32) as *const u32) }
        }
    }

    #[inline(always)]
    pub fn write(val: & super::Brr) {
       unsafe { *((0x40011800u32 + 0x14u32) as *mut u32) = val.raw; }
    }
}
...
impl Lckr {
    ...
    #[inline(always)]
    pub fn write(self) {
       unsafe { *((0x40011800u32 + 0x18u32) as *mut u32) = self.raw; }
    }
}
...
pub mod lckr {
    ...
    pub fn read() -> super::Lckr {
        super::Lckr {
            raw: unsafe { *((0x40011800u32 + 0x18u32) as *const u32) }
        }
    }

    #[inline(always)]
    pub fn write(val: & super::Lckr) {
       unsafe { *((0x40011800u32 + 0x18u32) as *mut u32) = val.raw; }
    }
}
