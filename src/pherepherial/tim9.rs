...
pub mod egr {
    pub mod tg {
        pub fn get() -> u32 {
            unsafe {
                (core::ptr::read_volatile(0x40014C14u32 as *const u32) >> 6) & 0x1
            }
        }

        pub fn set(val: u32) {
            unsafe {
                let mut reg = core::ptr::read_volatile(0x40014C14u32 as *const u32);
                reg &= 0xFFFFFFFEu32;
                reg |= (val & 0x1) << 6;
    ...
    pub mod cc2g {
        pub fn get() -> u32 {
            unsafe {
                (core::ptr::read_volatile(0x40014C14u32 as *const u32) >> 2) & 0x1
            }
        }
    ...
    pub mod cc1g {
        pub fn get() -> u32 {
            unsafe {
                (core::ptr::read_volatile(0x40014C14u32 as *const u32) >> 1) & 0x1
            }
        }
    ...
    pub mod ug {
        pub fn get() -> u32 {
            unsafe {
                core::ptr::read_volatile(0x40014C14u32 as *const u32) & 0x1
            }
        }
