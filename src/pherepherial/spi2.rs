...
impl Cr1 {
    ...
    #[inline(always)]
    pub fn write(self) {
       unsafe { *((0x40003800 + 0x0) as *mut u32) = self.raw; }
    }
}
...
impl Cr2 {
    ...
    #[inline(always)]
    pub fn write(self) {
       unsafe { *((0x40003800 + 0x4) as *mut u32) = self.raw; }
    }
}
...
impl Sr {
    ...
    #[inline(always)]
    pub fn write(self) {
       unsafe { *((0x40003800 + 0x8) as *mut u32) = self.raw; }
    }
}
...
impl Dr {
    ...
    #[inline(always)]
    pub fn write(self) {
       unsafe { *((0x40003800 + 0xC) as *mut u32) = self.raw; }
    }
}
...
impl Crcpr {
    ...
    #[inline(always)]
    pub fn write(self) {
       unsafe { *((0x40003800 + 0x10) as *mut u32) = self.raw; }
    }
}
...
impl Rxcrcr {
    ...
    #[inline(always)]
    pub fn write(self) {
       unsafe { *((0x40003800 + 0x14) as *mut u32) = self.raw; }
    }
}
...
impl Txcrcr {
    ...
    #[inline(always)]
    pub fn write(self) {
       unsafe { *((0x40003800 + 0x18) as *mut u32) = self.raw; }
    }
}
...
impl I2scfgr {
    ...
    #[inline(always)]
    pub fn write(self) {
       unsafe { *((0x40003800 + 0x1C) as *mut u32) = self.raw; }
    }
}
...
impl I2spr {
    ...
    #[inline(always)]
    pub fn write(self) {
       unsafe { *((0x40003800 + 0x20) as *mut u32) = self.raw; }
    }
}
