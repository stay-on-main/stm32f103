...
impl Cr1 {
    ...
    #[inline(always)]
    pub fn write(self) {
       unsafe { *((0x40002000u32 + 0x0u32) as *mut u32) = self.raw; }
    }
}
...
pub mod cr1 {
    ...
    pub fn read() -> super::Cr1 {
        super::Cr1 {
            raw: unsafe { *((0x40002000u32 + 0x0u32) as *const u32) }
        }
    }

    #[inline(always)]
    pub fn write(val: & super::Cr1) {
       unsafe { *((0x40002000u32 + 0x0u32) as *mut u32) = val.raw; }
    }
}
...
impl Cr2 {
    ...
    #[inline(always)]
    pub fn write(self) {
       unsafe { *((0x40002000u32 + 0x4u32) as *mut u32) = self.raw; }
    }
}
...
pub mod cr2 {
    ...
    pub fn read() -> super::Cr2 {
        super::Cr2 {
            raw: unsafe { *((0x40002000u32 + 0x4u32) as *const u32) }
        }
    }

    #[inline(always)]
    pub fn write(val: & super::Cr2) {
       unsafe { *((0x40002000u32 + 0x4u32) as *mut u32) = val.raw; }
    }
}
...
impl Dier {
    ...
    #[inline(always)]
    pub fn write(self) {
       unsafe { *((0x40002000u32 + 0xCu32) as *mut u32) = self.raw; }
    }
}
...
pub mod dier {
    ...
    pub fn read() -> super::Dier {
        super::Dier {
            raw: unsafe { *((0x40002000u32 + 0xCu32) as *const u32) }
        }
    }

    #[inline(always)]
    pub fn write(val: & super::Dier) {
       unsafe { *((0x40002000u32 + 0xCu32) as *mut u32) = val.raw; }
    }
}
...
impl Sr {
    ...
    #[inline(always)]
    pub fn write(self) {
       unsafe { *((0x40002000u32 + 0x10u32) as *mut u32) = self.raw; }
    }
}
...
pub mod sr {
    ...
    pub fn read() -> super::Sr {
        super::Sr {
            raw: unsafe { *((0x40002000u32 + 0x10u32) as *const u32) }
        }
    }

    #[inline(always)]
    pub fn write(val: & super::Sr) {
       unsafe { *((0x40002000u32 + 0x10u32) as *mut u32) = val.raw; }
    }
}
...
impl Egr {
    ...
    #[inline(always)]
    pub fn write(self) {
       unsafe { *((0x40002000u32 + 0x14u32) as *mut u32) = self.raw; }
    }
}
...
pub mod egr {
    ...
    pub fn read() -> super::Egr {
        super::Egr {
            raw: unsafe { *((0x40002000u32 + 0x14u32) as *const u32) }
        }
    }

    #[inline(always)]
    pub fn write(val: & super::Egr) {
       unsafe { *((0x40002000u32 + 0x14u32) as *mut u32) = val.raw; }
    }
}
...
impl Ccmr1_output {
    ...
    #[inline(always)]
    pub fn write(self) {
       unsafe { *((0x40002000u32 + 0x18u32) as *mut u32) = self.raw; }
    }
}
...
pub mod ccmr1_output {
    ...
    pub fn read() -> super::Ccmr1_output {
        super::Ccmr1_output {
            raw: unsafe { *((0x40002000u32 + 0x18u32) as *const u32) }
        }
    }

    #[inline(always)]
    pub fn write(val: & super::Ccmr1_output) {
       unsafe { *((0x40002000u32 + 0x18u32) as *mut u32) = val.raw; }
    }
}
...
impl Ccer {
    ...
    #[inline(always)]
    pub fn write(self) {
       unsafe { *((0x40002000u32 + 0x20u32) as *mut u32) = self.raw; }
    }
}
...
pub mod ccer {
    ...
    pub fn read() -> super::Ccer {
        super::Ccer {
            raw: unsafe { *((0x40002000u32 + 0x20u32) as *const u32) }
        }
    }

    #[inline(always)]
    pub fn write(val: & super::Ccer) {
       unsafe { *((0x40002000u32 + 0x20u32) as *mut u32) = val.raw; }
    }
}
...
impl Cnt {
    ...
    #[inline(always)]
    pub fn write(self) {
       unsafe { *((0x40002000u32 + 0x24u32) as *mut u32) = self.raw; }
    }
}
...
pub mod cnt {
    ...
    pub fn read() -> super::Cnt {
        super::Cnt {
            raw: unsafe { *((0x40002000u32 + 0x24u32) as *const u32) }
        }
    }

    #[inline(always)]
    pub fn write(val: & super::Cnt) {
       unsafe { *((0x40002000u32 + 0x24u32) as *mut u32) = val.raw; }
    }
}
...
impl Psc {
    ...
    #[inline(always)]
    pub fn write(self) {
       unsafe { *((0x40002000u32 + 0x28u32) as *mut u32) = self.raw; }
    }
}
...
pub mod psc {
    ...
    pub fn read() -> super::Psc {
        super::Psc {
            raw: unsafe { *((0x40002000u32 + 0x28u32) as *const u32) }
        }
    }

    #[inline(always)]
    pub fn write(val: & super::Psc) {
       unsafe { *((0x40002000u32 + 0x28u32) as *mut u32) = val.raw; }
    }
}
...
impl Arr {
    ...
    #[inline(always)]
    pub fn write(self) {
       unsafe { *((0x40002000u32 + 0x2Cu32) as *mut u32) = self.raw; }
    }
}
...
pub mod arr {
    ...
    pub fn read() -> super::Arr {
        super::Arr {
            raw: unsafe { *((0x40002000u32 + 0x2Cu32) as *const u32) }
        }
    }

    #[inline(always)]
    pub fn write(val: & super::Arr) {
       unsafe { *((0x40002000u32 + 0x2Cu32) as *mut u32) = val.raw; }
    }
}
...
impl Ccr1 {
    ...
    #[inline(always)]
    pub fn write(self) {
       unsafe { *((0x40002000u32 + 0x34u32) as *mut u32) = self.raw; }
    }
}
...
pub mod ccr1 {
    ...
    pub fn read() -> super::Ccr1 {
        super::Ccr1 {
            raw: unsafe { *((0x40002000u32 + 0x34u32) as *const u32) }
        }
    }

    #[inline(always)]
    pub fn write(val: & super::Ccr1) {
       unsafe { *((0x40002000u32 + 0x34u32) as *mut u32) = val.raw; }
    }
}
