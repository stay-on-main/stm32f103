...
pub mod eccr2 {
    pub mod eccx {
        ...
        pub fn set(val: u32) {
            unsafe {
                let mut reg = core::ptr::read_volatile(0xA0000074u32 as *const u32);
                reg &= 0x0u32;
                reg |= val & 0xFFFFFFFF;
                core::ptr::write_volatile(0xA0000074u32 as *mut u32, reg);
            }
        }
    }
}
...
pub mod eccr3 {
    pub mod eccx {
        ...
        pub fn set(val: u32) {
            unsafe {
                let mut reg = core::ptr::read_volatile(0xA0000094u32 as *const u32);
                reg &= 0x0u32;
                reg |= val & 0xFFFFFFFF;
                core::ptr::write_volatile(0xA0000094u32 as *mut u32, reg);
            }
        }
    }
}
