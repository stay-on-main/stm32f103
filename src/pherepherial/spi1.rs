...
pub mod rxcrcr {
    pub mod rxcrc {
        ...
        pub fn set(val: u32) {
            unsafe {
                let mut reg = core::ptr::read_volatile(0x40013014u32 as *const u32);
                reg &= 0xFFFF0000u32;
                reg |= val & 0xFFFF;
                core::ptr::write_volatile(0x40013014u32 as *mut u32, reg);
            }
        }
    }
}
...
pub mod txcrcr {
    pub mod txcrc {
        ...
        pub fn set(val: u32) {
            unsafe {
                let mut reg = core::ptr::read_volatile(0x40013018u32 as *const u32);
                reg &= 0xFFFF0000u32;
                reg |= val & 0xFFFF;
                core::ptr::write_volatile(0x40013018u32 as *mut u32, reg);
            }
        }
    }
}
