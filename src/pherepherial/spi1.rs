...
impl Cr1 {
    ...
    #[inline(always)]
    pub fn write(self) {
       unsafe { *((0x40013000u32 + 0x0u32) as *mut u32) = self.raw; }
    }
}
...
pub mod cr1 {
    ...
    pub fn read() -> super::Cr1 {
        super::Cr1 {
            raw: unsafe { *((0x40013000u32 + 0x0u32) as *const u32) }
        }
    }

    #[inline(always)]
    pub fn write(val: & super::Cr1) {
       unsafe { *((0x40013000u32 + 0x0u32) as *mut u32) = val.raw; }
    }
}
...
impl Cr2 {
    ...
    #[inline(always)]
    pub fn write(self) {
       unsafe { *((0x40013000u32 + 0x4u32) as *mut u32) = self.raw; }
    }
}
...
pub mod cr2 {
    ...
    pub fn read() -> super::Cr2 {
        super::Cr2 {
            raw: unsafe { *((0x40013000u32 + 0x4u32) as *const u32) }
        }
    }

    #[inline(always)]
    pub fn write(val: & super::Cr2) {
       unsafe { *((0x40013000u32 + 0x4u32) as *mut u32) = val.raw; }
    }
}
...
impl Sr {
    ...
    #[inline(always)]
    pub fn write(self) {
       unsafe { *((0x40013000u32 + 0x8u32) as *mut u32) = self.raw; }
    }
}
...
pub mod sr {
    ...
    pub fn read() -> super::Sr {
        super::Sr {
            raw: unsafe { *((0x40013000u32 + 0x8u32) as *const u32) }
        }
    }

    #[inline(always)]
    pub fn write(val: & super::Sr) {
       unsafe { *((0x40013000u32 + 0x8u32) as *mut u32) = val.raw; }
    }
}
...
impl Dr {
    ...
    #[inline(always)]
    pub fn write(self) {
       unsafe { *((0x40013000u32 + 0xCu32) as *mut u32) = self.raw; }
    }
}
...
pub mod dr {
    ...
    pub fn read() -> super::Dr {
        super::Dr {
            raw: unsafe { *((0x40013000u32 + 0xCu32) as *const u32) }
        }
    }

    #[inline(always)]
    pub fn write(val: & super::Dr) {
       unsafe { *((0x40013000u32 + 0xCu32) as *mut u32) = val.raw; }
    }
}
...
impl Crcpr {
    ...
    #[inline(always)]
    pub fn write(self) {
       unsafe { *((0x40013000u32 + 0x10u32) as *mut u32) = self.raw; }
    }
}
...
pub mod crcpr {
    ...
    pub fn read() -> super::Crcpr {
        super::Crcpr {
            raw: unsafe { *((0x40013000u32 + 0x10u32) as *const u32) }
        }
    }

    #[inline(always)]
    pub fn write(val: & super::Crcpr) {
       unsafe { *((0x40013000u32 + 0x10u32) as *mut u32) = val.raw; }
    }
}
...
impl Rxcrcr {
    ...
    #[inline(always)]
    pub fn write(self) {
       unsafe { *((0x40013000u32 + 0x14u32) as *mut u32) = self.raw; }
    }
}
...
pub mod rxcrcr {
    ...
    pub fn read() -> super::Rxcrcr {
        super::Rxcrcr {
            raw: unsafe { *((0x40013000u32 + 0x14u32) as *const u32) }
        }
    }

    #[inline(always)]
    pub fn write(val: & super::Rxcrcr) {
       unsafe { *((0x40013000u32 + 0x14u32) as *mut u32) = val.raw; }
    }
}
...
impl Txcrcr {
    ...
    #[inline(always)]
    pub fn write(self) {
       unsafe { *((0x40013000u32 + 0x18u32) as *mut u32) = self.raw; }
    }
}
...
pub mod txcrcr {
    ...
    pub fn read() -> super::Txcrcr {
        super::Txcrcr {
            raw: unsafe { *((0x40013000u32 + 0x18u32) as *const u32) }
        }
    }

    #[inline(always)]
    pub fn write(val: & super::Txcrcr) {
       unsafe { *((0x40013000u32 + 0x18u32) as *mut u32) = val.raw; }
    }
}
...
impl I2scfgr {
    ...
    #[inline(always)]
    pub fn write(self) {
       unsafe { *((0x40013000u32 + 0x1Cu32) as *mut u32) = self.raw; }
    }
}
...
pub mod i2scfgr {
    ...
    pub fn read() -> super::I2scfgr {
        super::I2scfgr {
            raw: unsafe { *((0x40013000u32 + 0x1Cu32) as *const u32) }
        }
    }

    #[inline(always)]
    pub fn write(val: & super::I2scfgr) {
       unsafe { *((0x40013000u32 + 0x1Cu32) as *mut u32) = val.raw; }
    }
}
...
impl I2spr {
    ...
    #[inline(always)]
    pub fn write(self) {
       unsafe { *((0x40013000u32 + 0x20u32) as *mut u32) = self.raw; }
    }
}
...
pub mod i2spr {
    ...
    pub fn read() -> super::I2spr {
        super::I2spr {
            raw: unsafe { *((0x40013000u32 + 0x20u32) as *const u32) }
        }
    }

    #[inline(always)]
    pub fn write(val: & super::I2spr) {
       unsafe { *((0x40013000u32 + 0x20u32) as *mut u32) = val.raw; }
    }
}
